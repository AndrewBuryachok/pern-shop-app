export enum DeliveryError {
  ALREADY_EXISTS = '400: Delivery already exists',
  ...
  CREATE_SHOP_FAILED = '500: Failed to create shop delivery',
  CREATE_MARKET_FAILED = '500: Failed to create market delivery',
  CREATE_STORAGE_FAILED = '500: Failed to create storagedelivery',
