...
import { useCompleteMarketDeliveryMutation } from './markets-deliveries.api';
...
export default function CompleteMarketDeliveryModal({
  data: marketDelivery,
}: Props) {
...
export const completeMarketDeliveryAction = {
  open: (marketDelivery: MarketDelivery) =>
    openModal({
      title: t('actions.complete') + ' ' + t('modals.deliveries'),
      children: <CompleteMarketDeliveryModal data={marketDelivery} />,
    }),
