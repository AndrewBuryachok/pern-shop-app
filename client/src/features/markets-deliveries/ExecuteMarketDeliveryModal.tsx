...
import { useExecuteMarketDeliveryMutation } from './markets-deliveries.api';
...
export default function ExecuteMarketDeliveryModal({
  data: marketDelivery,
}: Props) {
...
export const executeMarketDeliveryAction = {
  open: (marketDelivery: MarketDelivery) =>
    openModal({
      title: t('actions.execute') + ' ' + t('modals.deliveries'),
      children: <ExecuteMarketDeliveryModal data={marketDelivery} />,
    }),
